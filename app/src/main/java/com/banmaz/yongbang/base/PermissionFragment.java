...
public abstract class PermissionFragment<
    V extends AppBaseView, T extends AppBaseFragmentPresenter<V>>
  ...
  public void onRequestPermissionsResult(
    ...
    PermissionFragmentPermissionsDispatcher.onRequestPermissionsResult(
        this, requestCode, grantResults);
  }

  // 定位
  public void requestLocationWithCheck() {
    PermissionFragmentPermissionsDispatcher.requestLocationWithPermissionCheck(this);
  }
  ...
  public void showMediaSelectWithCheck(Bundle bundle, int requestCode) {
    PermissionFragmentPermissionsDispatcher.showMediaSelectWithPermissionCheck(
  ...
  public void showWriteStorageWithCheck() {
    PermissionFragmentPermissionsDispatcher.showWriteStorageWithPermissionCheck(this);
  }
  ...
  public void showReadPhoneWithCheck() {
    PermissionFragmentPermissionsDispatcher.showReadPhoneWithPermissionCheck(this);
  }
  ...
  protected void showSettingDialog(String feature) {
    ...
    CenterDialog.create(
        getActivity(),
        "提示",
        String.format("在设置-应用-%s-权限中开启%s权限, 以正常使用%s功能", name, feature, name),
        "取消",
